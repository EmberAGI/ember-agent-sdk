...
pub struct MintTokensResponseResult {
    ...
    #[serde(rename = "mintedToken", skip_serializing_if = "Option::is_none")]
    pub minted_token: Option<Box<models::MintTokensResponseResultMintedToken>>,
}

impl MintTokensResponseResult {
    pub fn new() -> MintTokensResponseResult {
